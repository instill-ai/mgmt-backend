...
// Transpiler data
type InfluxTranspiler struct {
	filter filtering.Filter
}

// Transpile executes the transpilation on the filter
func (t *InfluxTranspiler) Transpile() (string, error) {
...
func (t *InfluxTranspiler) transpileExpr(e *expr.Expr) (string, string, error) {
...
func (t *InfluxTranspiler) transpileConstExpr(e *expr.Expr) (string, error) {
...
func (t *InfluxTranspiler) transpileCallExpr(e *expr.Expr) (string, error) {
...
func (t *InfluxTranspiler) transpileIdentExpr(e *expr.Expr) (string, string, error) {
...
func (t *InfluxTranspiler) transpileSelectExpr(e *expr.Expr) (string, error) {
	return "", fmt.Errorf("does not support SELECT expression for now")
}

func (t *InfluxTranspiler) transpileNotCallExpr(e *expr.Expr) (string, error) {
...
func (t *InfluxTranspiler) transpileComparisonCallExpr(e *expr.Expr, op interface{}) (string, error) {
	callExpr := e.GetCallExpr()
...
func (t *InfluxTranspiler) transpileBinaryLogicalCallExpr(e *expr.Expr, op clause.Expression) (string, error) {
	callExpr := e.GetCallExpr()
	if len(callExpr.Args) != 2 {
		return "", fmt.Errorf(
			"unexpected number of arguments to `%s`: %d",
...
func (t *InfluxTranspiler) transpileHasCallExpr(e *expr.Expr) (string, error) {
	callExpr := e.GetCallExpr()
	if len(callExpr.Args) != 2 {
...
func (t *InfluxTranspiler) transpileTimestampCallExpr(e *expr.Expr) (string, error) {
