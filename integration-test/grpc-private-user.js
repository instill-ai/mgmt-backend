...
export function CheckPrivateGetUserAdmin() {
  ...
  group(`Management Private API: Get default user`, () => {
    ...
    check(client.invoke('core.mgmt.v1alpha.MgmtPrivateService/GetUserAdmin', {
      ...
      'core.mgmt.v1alpha.MgmtPrivateService/GetUserAdmin response type': (r) => r && r.message.user.type === "OWNER_TYPE_USER",
...
export function CheckPrivateLookUpUserAdmin() {
  ...
  group(`Management Private API: Look up default user by permalink`, () => {
    ...
    check(client.invoke('core.mgmt.v1alpha.MgmtPrivateService/LookUpUserAdmin', {
      ...
      'core.mgmt.v1alpha.MgmtPrivateService/LookUpUserAdmin response type': (r) => r && r.message.user.type === "OWNER_TYPE_USER",
...
export function CheckPrivateUpdateUserAdmin() {
  ...
  group(`Management Private API: Update default user`, () => {
    ...
    check(client.invoke('core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin', {
      user: userUpdate,
      update_mask: "email,firstName,lastName,orgName,role,newsletterSubscription,cookieToken"
    }), {
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin status': (r) => r && r.status == grpc.StatusOK,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response name unchanged': (r) => r && r.message.user.name === res.message.user.name,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response uid unchanged': (r) => r && r.message.user.uid === res.message.user.uid,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response id unchanged': (r) => r && r.message.user.id === res.message.user.id,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response type unchanged': (r) => r && r.message.user.type === res.message.user.type,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response email updated': (r) => r && r.message.user.email === userUpdate.email,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response customerId unchanged': (r) => r && r.message.user.customerId === res.message.user.customerId,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response firstName updated': (r) => r && r.message.user.firstName === userUpdate.first_name,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response lastName updated': (r) => r && r.message.user.lastName === userUpdate.last_name,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response orgName updated': (r) => r && r.message.user.orgName === userUpdate.org_name,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response role updated': (r) => r && r.message.user.role === userUpdate.role,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response newsletterSubscription updated': (r) => r && r.message.user.newsletterSubscription === userUpdate.newsletter_subscription,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response cookieToken updated': (r) => r && r.message.user.cookieToken === userUpdate.cookie_token,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response createTime unchanged': (r) => r && r.message.user.createTime === res.message.user.createTime,
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin response updateTime updated': (r) => r && r.message.user.updateTime !== res.message.user.updateTime,
    });
  ...
  group(`Management Private API: Update user with a non-exist role`, () => {
    ...
    check(client.invoke('core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin', {
      ...
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin status StatusInvalidArgument': (r) => r && r.status == grpc.StatusInvalidArgument,
    });
  });
  ...
  group(`Management Private API: Update non-exist user`, () => {
    check(client.invoke('core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin', {
      ...
      'core.mgmt.v1alpha.MgmtPrivateService/UpdateUserAdmin status StatusNotFound': (r) => r && r.status == grpc.StatusNotFound,
    });
  });
...
export function CheckPrivateCreateUserAdmin() {
  ...
  group("Management Private API: Create user with UUID as id", () => {
    ...
    check(client.invoke('core.mgmt.v1alpha.MgmtPrivateService/CreateUserAdmin', {
      user: {
        id: "2a06c2f7-8da9-4046-91ea-240f88a5d000"
      }
    }), {
      'core.mgmt.v1alpha.MgmtPrivateService/CreateUserAdmin status StatusInvalidArgument': (r) => r && r.status == grpc.StatusInvalidArgument,
    });
  ...
  group("Management Private API: Create user", () => {
    ...
    check(client.invoke('core.mgmt.v1alpha.MgmtPrivateService/CreateUserAdmin', {
      ...
      'core.mgmt.v1alpha.MgmtPrivateService/CreateUserAdmin status StatusOK': (r) => r && r.status == grpc.StatusUnimplemented,
    });
...
export function CheckPrivateDeleteUserAdmin() {
  ...
  group(`Management Private API: Delete user`, () => {
    ...
    check(client.invoke('core.mgmt.v1alpha.MgmtPrivateService/DeleteUserAdmin', {
      name: `users/${constant.defaultUser.id}`,
    }), {
      'core.mgmt.v1alpha.MgmtPrivateService/DeleteUserAdmin status StatusOK': (r) => r && r.status == grpc.StatusUnimplemented,
    });
